...
export const defaultContent: SiteContent = {
  ...
  gallery: [
    ...
    ['salle-banquette', 'Banquette et table sous le médaillon tropical'],
    ['salle-alcoves', 'Deux alcôves de la salle et leurs médaillons fleuris'],
    ['salle-profondeur', 'Table dressée dans la profondeur de la salle'],
    ['brunch-plateau', 'Plateau de brunch : œufs bénédicte, bol granola et croissant salé'],
    ['granola-latte', 'Bol de granola aux fruits et cappuccino'],
    ['chocolat-main', 'Chocolat chaud servi en verre'],
  ].map(([slug, alt], index) => ({
    id: `gal-${slug}`,
